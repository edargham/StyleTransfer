...
class StyleContentModel(keras.Model):
    ...
    def call(self, inputs):
        inputs = inputs * 255.0
        # Preprocess input according to MobileNetV2
        ...
        style_outputs = backbone_out[-len(self.style_layers):]  # Adjust style layers
        content_outputs = backbone_out[:len(self.content_layers)]  # Adjust content layers
